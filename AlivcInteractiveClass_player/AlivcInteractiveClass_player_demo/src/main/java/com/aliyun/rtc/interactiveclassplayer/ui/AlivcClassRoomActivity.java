...
public class AlivcClassRoomActivity extends AppCompatActivity implements TitleBar.BackBtnListener, TitleBar.MenuBtnListener, BottomFunctionAdapter.FunctionCheckedListener, View.OnClickListener, StudentListAdapter.ItemClickListener {
    ...
    private void initView() {
        ...
        mPlaySurfaceview = findViewById(R.id.alivc_big_interactive_class_surface_play);
         rlContent = findViewById(R.id.alivc_big_interactive_class_rl_content_class_room);
        LinearLayout aliyun_big_interactice_back = findViewById(R.id.aliyun_big_interactice_back);
        TextView alivc_biginteractiveclass_tv_title = findViewById(R.id.alivc_biginteractiveclass_tv_title);
        alivc_biginteractiveclass_tv_title.setText(getString(R.string.alivc_biginteractiveclass_string_title_num)+mChannelId);
        initFunctionViews();
        initStudentList();
        ...
        aliyun_big_interactice_back.setOnClickListener(this);
    }
